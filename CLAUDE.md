...
планирование, `/start` идемпотентен. Дальше — Phase 4+ (UX рабочих часов/лимитов на странице
«Настройки» — виджеты есть, нужна доводка; масштаб: несколько воркеров; подписки/отписки).
