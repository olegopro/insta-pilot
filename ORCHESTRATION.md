...
### Комбинирование со своими субагентами
Свои Task/Agent-субагенты Claude Code (в т.ч. в worktree) и делегаты `kiro-cli`/Codex комбинируются:
разные каналы и директории идут конкурентно. Фан-аут дашбордов из §5 можно вести своими
`dashboard-builder`-агентами, а отдельные куски (бэкенд, парсинг, второе мнение) — отдавать
`kiro-cli`/Codex.
