...
|---|------|--------|--------|--------------------------|
| — | Паутина доков | ✅ написана | не закоммичено | закоммитить как первую группу (по запросу) |
| 0 | [verify](phases/phase-0-verify.md) | 🟡 скрипт готов | — | прогон на живом аккаунте (нужен тестовый аккаунт + согласие на reversible); зафиксировать формат ответов / `is_pinned` |
