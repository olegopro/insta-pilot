...
>
> Учебный раздел «Пробелы в знаниях» из `TODO.md` сюда НЕ входит — он целиком в `learn.md`.
>
> Легенда статусов:
...
**Как запускать (см. `../orchestration/playbook.md` / `../orchestration/agent-factory.md`):**
